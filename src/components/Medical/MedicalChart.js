...
const MedicalChart = () => {
    ...
    const [ecgData, setEcgData] = useState({
        name: "ECG",
        values: [9058.98, 9025.72, 9052.14, 8988.03, 8965.34, 9068.58, 9055.19, 9056.22, 9017.17,
            ...
            9011.04, 9059.13, 8984.89, 9055.23, 9033.98, 9007.89, 9044.15, 9055.65, 9023.46,
            9028.17, 9082.89, 9086.79, 9082.11, 9026.55, 9088.57, 9076.98, 9023.01, 9092.56,
            9084.17, 9001.12, 9010.91, 9061.64, 9022.25, 9004.84],
    });
    const [eogData, setEogData] = useState({
        name: "EOG",
        values: [13919.22, 13889.29, 13813.82, 13871.65, 13950.93, 13933.47, 13907.86, 13969.02,
    ...
    const [emgData, setEmgData] = useState({
        name: "EMG",
        values: [9960.91, 9922.75, 9979.3, 9950.57, 9914.79, 9976.91, 9946.85, 9998.39, 9943.38,
    ...
    const [airflowData, setAirflowData] = useState({
        name: "AirFlow",
        values: [13534.21, 13555.61, 13517.17, 13538.03, 13554.52, 13532.23, 13577.89, 13506.43,
        ...
        name: "GSR",
        values: [14068.49, 14069.66, 14061.63, 14059.05, 14047.21, 14022.95, 14006.8, 14052.22,
